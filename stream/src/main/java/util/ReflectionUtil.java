...
public class ReflectionUtil {
    ...
    public Method getInstanceToMethod(Class classObject, String instanceName) throws NoSuchMethodException {
    ...
    public Object invokeGetter(Class classObject, Method method) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
